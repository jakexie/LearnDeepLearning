...
def create_fcn_16s_v2(input_shape=None, weight_decay=0., batch_momentum=0.9, batch_shape=None, classes=21):
    if batch_shape:
...
def main(argv):
    ...
    model = create_fcn_16s_v2((config.image_min_dims, config.image_min_dims, 3))
